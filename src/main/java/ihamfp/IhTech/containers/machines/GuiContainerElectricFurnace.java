...
public class GuiContainerElectricFurnace extends GuiContainerDecorated {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		drawVertProgressBar(guiLeft+80, guiTop+33, te.cookTime, (te.cookTicksLeft>0)?te.cookTime-te.cookTicksLeft:0, Color.YELLOW.getRGB()); // cooking bar
		drawBurningLevel(guiLeft+63, guiTop+52, (te.cookTicksLeft>0)?1:0, 1);
